...
if (isset($_POST['dev_add'])) {
    ...
    if (empty($dev_name)) {
        echo '<p class="alert alert-danger">Please, Set the Program!!</p>';
    }
    elseif (empty($dev_dep)) {
        echo '<p class="alert alert-danger">Please, Set the Class Name!!</p>';
    }
    else{
        ...
        $query = "SELECT device_dep, device_name FROM devices WHERE device_dep = '" . $dev_dep . "' AND device_name = '" . $dev_name . "';"; // Put querry SSELECT
        $exec = mysqli_query($conn, $query); 

        // Check if theres duplicte
