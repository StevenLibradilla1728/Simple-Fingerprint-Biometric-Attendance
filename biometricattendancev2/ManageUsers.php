...
<head>
  ...
  integrity="sha384-4Q6Gf2aSP4eDXB8Miphtr37CMZZQ5oXLH2yaXMJ2w8e2ZtHTl7GptT4jmndRuHDT" crossorigin="anonymous"></style>
	<link rel="stylesheet" type="text/css" href="css/manageusers.css">

	<style>
		.spin {
			font-size: 40px;
			color: blue; /* BAGUHIN kung gusto mo ng ibang kulay */

			animation: spin .5s alternate infinite; /* Corrected this line */
		}
...
<main>
	<h1 class="slideInDown animated">Add a new Student</h1>
	<div class="form-style-5 slideInDown animated">
		<form enctype="multipart/form-data">
			<fieldset>
				<label for="Device"><b>Class:</b></label>
			...
			<label>
				...
				<div class="row">
					<div class="col-lg-3 m-0 p-0 g-1">
					...
					<div class="col-lg-3 m-0 p-0 g-1">
						<button type="button" name="user_enrollment" class="user_enrollment">ENROLL</button>
					</div>
				</div>
		</form>
	</div>
	...
	<!-- DIV FOR LOADING -->
	 <div id="loading" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; z-index: 9999; background-color: rgba(0,0,0,0.4); display: none;">
		<div class="msgBoxLoad" style="padding: 10px 20px; background-color: white; border-radius: 6;">
			<h1>ENROLLING</h1>
			<h2>Put the finger on the scanner</h2>

			<div class="spin d-flex align-items-center justify-content-center">Please Wait...</div>
		</div>
	 </div>
</main>
